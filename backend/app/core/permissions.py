...
EMPLOYEE_IDENTITY_VIEW = "employee.identity.view"
...
ALL_PERMISSIONS: frozenset[str] = frozenset({
    ...
    EMPLOYEE_AVAILABILITY_EDIT, EMPLOYEE_PREFERENCE_EDIT, EMPLOYEE_PAYROLL_VIEW, EMPLOYEE_CONTRACT_EDIT, EMPLOYEE_IDENTITY_VIEW,
})
